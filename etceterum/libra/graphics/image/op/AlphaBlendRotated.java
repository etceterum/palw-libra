...
//like AlphaBlend, but rotate the source by the given angle before blending
public final class AlphaBlendRotated extends SourceOp {
    
    private double angle = 0;
    
    public AlphaBlendRotated() {
        // no-op
    }
    
    public AlphaBlendRotated(double angle) {
        setAngle(angle);
    }
    
    public AlphaBlendRotated(Image source) {
        super(source);
    }
    
    public AlphaBlendRotated(Image source, double angle) {
        super(source);
        setAngle(angle);
    }
    
    public AlphaBlendRotated resetAngle() {
        return setAngle(0);
    }
    
    public AlphaBlendRotated setAngle(double value) {
        angle = value;
        return this;
    }
        ...
        for (int targetY = 0; targetY < targetHeight; ++targetY, targetIdx += targetSkipInBytes) {
            ...
            for (int targetX = 0; targetX < targetWidth; ++targetX, targetIdx += 4) {
                ...
                if (haveNorth && haveWest) {
                    ...
                    nwA = sourceA*sourceA + targetA*oneMinusSourceA;
                }
                else {
                    nwR = scaledTargetR;
                    nwG = scaledTargetG;
                ...
                if (haveNorth && haveEast) {
                    ...
                    neA = sourceA*sourceA + targetA*oneMinusSourceA;
                }
                else {
                    neR = scaledTargetR;
                    neG = scaledTargetG;
                ...
                if (haveSouth && haveWest) {
                    ...
                    swA = sourceA*sourceA + targetA*oneMinusSourceA;
                }
                else {
                    swR = scaledTargetR;
                    swG = scaledTargetG;
                ...
                if (haveSouth && haveEast) {
                    ...
                    seA = sourceA*sourceA + targetA*oneMinusSourceA;
                }
                else {
                    seR = scaledTargetR;
                    seG = scaledTargetG;
