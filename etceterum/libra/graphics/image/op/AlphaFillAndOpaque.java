...
// like Fill_SrcAlpha_OneMinusSrcAlpha but preserve target alpha
public class AlphaFillAndOpaque extends ColorOp {
    public AlphaFillAndOpaque() {
        // no-op
    }
    
    public AlphaFillAndOpaque(byte r, byte g, byte b, byte a) {
        super(r, g, b, a);
    }
    
    public AlphaFillAndOpaque(byte r, byte g, byte b) {
        super(r, g, b);
    }
    
    public AlphaFillAndOpaque(int rgba) {
        super(rgba);
    }
    ...
    public Image execute(Image input) {
        ...
        int targetR, targetG, targetB, oneMinusSourceA, r, g, b;
